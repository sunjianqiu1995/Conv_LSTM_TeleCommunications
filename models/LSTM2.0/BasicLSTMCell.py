...
class BasicLSTMCell(ConvRNNCell):
  ...
  """
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope or type(self).__name__):  # "BasicLSTMCell"
            ...
            concat = _linear([inputs, h], self.filter_size, self.num_features * 4, True)
...
def _linear(args, filter_size, num_features, bias, bias_start=0.0, scope=None):
    """convolution:
  Args:
